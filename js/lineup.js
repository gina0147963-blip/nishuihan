...
function _buildPlayerBoardHTML(ev){
  ...
  if(myIsReserve){
    ...
    boardHTML=`<div class="team-block">
      <div class="team-hd"><div class="team-label"><span class="team-badge tb-rsv">🟡 候補</span><span class="team-cnt">${names.length}人</span></div></div>
      <div class="team-cards reserve-pool">${names.map(n=>playerCardHTML(n,members,-1,'reserve',false,roles[n],false,ev)).join('')}</div>
    </div>`;
  } else {
