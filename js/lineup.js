    ...
    <div class="sec-head">
      ...
      <div class="sec-actions">
        ...
        ${curEv?`
          ...
          <button class="btn btn-outline sm" onclick="openCoreTeamEditor()">👥 編輯固定團</button>
        `:''}
      </div>
    </div>
...
function buildPoolGroups(ev){
  ...
  return sec('✅ 已報名',attendNames,'var(--ok)',true)+sec('⬜ 未報名',otherNames,'var(--txt2)',true)+sec('🌙 請假',absentNames,'var(--txt3)',false)||'<p class="hint">無符合玩家</p>';
}
