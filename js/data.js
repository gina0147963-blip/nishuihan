...
// ============================================================
const JOBS = [
  {id:'jiuling',  name:'九靈',  color:'#7c4dbf', icon:'🦊'},
  {id:'longyin',  name:'龍吟',  color:'#45c08c', icon:'🐉'},
  {id:'shenxiang',name:'神相',  color:'#3d5bdb', icon:'🔥'},
  {id:'suwen',    name:'素問',  color:'#f2a7bb', icon:'☯'},
  {id:'suimeng',  name:'碎夢',  color:'#7ba3b0', icon:'⚔'},
  {id:'tieyi',    name:'鐵衣',  color:'#e8a33d', icon:'🛡'},
  {id:'xehe',     name:'血河',  color:'#c0392b', icon:'🩸'},
  {id:'xuanji',   name:'玄機',  color:'#9a9a52', icon:'🪽'},
  {id:'chaoguang',name:'潮光',  color:'#6db3d9', icon:'🌊'},
];
const TEAMS = [
