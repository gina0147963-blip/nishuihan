...
function renderAdminMembers(pane){
  ...
  pane.innerHTML=`<div class="sec-head">
    ...
    <div class="sec-actions">
      ...
      <button class="btn btn-outline sm" onclick="rebuildFromMatches()">🔄 從比賽紀錄補齊成員</button>
  ...
  <div class="tbl-wrap"><table>
    ...
    <tbody id="members-tbody">${tbody||'<tr><td colspan="7" style="text-align:center;color:var(--txt3);padding:24px">尚無成員</td></tr>'}</tbody>
  </table></div>`;
}
